SELECT userCode,
       ...
       drawAt,
       orderId,
       CAST(SUM(com1DUsd) AS DECIMAL(15, 2))          com1DUsd,
       CAST(SUM(com1DKhr) AS DECIMAL(15, 2))          com1DKhr,
       ...
       CAST(SUM(betAmount1DUsd) AS DECIMAL(15, 2))    betAmount1DUsd,
       ...
       CAST(SUM(betAmount1DKhr) AS DECIMAL(15, 2))    betAmount1DKhr,
       ...
       CAST(SUM(winAmount1DUsd) AS DECIMAL(15, 2))    winAmount1DUsd,
       ...
       CAST(SUM(winAmount1DKhr) AS DECIMAL(15, 2))    winAmount1DKhr,
       ...
       CAST(SUM(rewardAmount1DUsd) AS DECIMAL(15, 2)) rewardAmount1DUsd,
       ...
       CAST(SUM(rewardAmount1DKhr) AS DECIMAL(15, 2)) rewardAmount1DKhr,
...
FROM (
         ...
         FROM vnone_order_items oi
                  LEFT JOIN (SELECT oii, wq FROM vnone_win_order_items) lwoi ON lwoi.oii = oi.id
                  left join vnone_orders o on o.id = oi.oi
         WHERE DATE(oi.draw_at) BETWEEN DATE(:filterByStartDate) AND DATE(:filterByEndDate)
