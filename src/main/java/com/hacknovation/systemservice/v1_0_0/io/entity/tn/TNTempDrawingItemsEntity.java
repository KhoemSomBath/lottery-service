...
@Entity
@Table(name = "tn_temp_drawing_items")
public class TNTempDrawingItemsEntity extends BaseDrawingItemsEntity {
    @Column(name = "column_number")
    private Integer columnNumber = 1;
    public TNTempDrawingItemsEntity(DrawingItemsDTO drawingItemsDTO) {
