...
@Entity
@Table(name = "leap_temp_drawing_items")
public class LeapTempDrawingItemsEntity extends BaseDrawingItemsEntity {
    public LeapTempDrawingItemsEntity(DrawingItemsDTO drawingItemsDTO) {
