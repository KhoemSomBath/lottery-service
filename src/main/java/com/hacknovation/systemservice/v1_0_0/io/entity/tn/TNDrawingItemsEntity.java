...
@Entity
@Table(name = "tn_drawing_items")
public class TNDrawingItemsEntity extends BaseDrawingItemsEntity {
    @Column(name = "column_number")
    private Integer columnNumber = 1;
    public TNDrawingItemsEntity(DrawingItemsDTO drawingItemsDTO) {
