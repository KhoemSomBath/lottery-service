...
@Entity
@Table(name = "khr_drawing_items")
public class KHDrawingItemsEntity extends BaseDrawingItemsEntity {
    @Column(name = "column_number")
    private Integer columnNumber = 1;
    public KHDrawingItemsEntity(DrawingItemsDTO drawingItemsDTO) {
