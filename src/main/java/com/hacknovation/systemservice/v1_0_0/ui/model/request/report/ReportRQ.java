...
public class ReportRQ {
    ...
    public ReportRQ(HttpServletRequest request) {
        ...
        this.filterByStartDate = filterByStartDate != null && !filterByStartDate.isEmpty() ? filterByStartDate : "1997-01-01";
        this.filterByEndDate = filterByEndDate != null && !filterByEndDate.isEmpty() ? filterByEndDate+" "+"00:00:00" : filterByStartDate;
