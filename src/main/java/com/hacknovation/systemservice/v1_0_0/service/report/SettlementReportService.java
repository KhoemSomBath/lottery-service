...
import com.hacknovation.systemservice.v1_0_0.ui.model.response.report.clearing.SettlementItemRS;
...
public class SettlementReportService extends BaseServiceIP {
    ...
    public StructureRS getSettlementList() {
        ...
        try {
            ...
            Map<String, CurrencyRS> oldBalanceMap = oldBalanceUtility.getUserOldBalanceMap(reportRQ.getFilterByLotteryType(), userCodes, generalUtility.formatDateYYYYMMDD(endDate));
    ...
    private StructureRS getSelectedUserSettlementReport(SettlementRQ reportRQ, UserToken userToken) {
        ...
        for (Date date = start.getTime(); start.before(end); date = start.getTime()) {
            ...
            Map<String, CurrencyRS> oldBalanceMap = oldBalanceUtility.getUserOldBalanceMap(reportRQ.getFilterByLotteryType(), List.of(userEntity.getCode()), tomorrow);
